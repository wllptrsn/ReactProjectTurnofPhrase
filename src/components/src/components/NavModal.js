            ...
            <React.Fragment>
                ...
                <Modal isOpen={this.state.isModalOpen} navbar >
                    ...
                    <Nav navbar className="TitleText align-self-center">
                        <NavItem>
                            <NavLink onClick={this.toggleModal} className="nav-link" to="/home">
                                Home
                                    </NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink onClick={this.toggleModal} className="nav-link" to="/about">
                                About
                                    </NavLink>
                        </NavItem>
                        <NavItem>
                        ...
                        <NavItem>
                            <NavLink onClick={this.toggleModal} className="nav-link" to="/team">
                                Team
                                    </NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink onClick={this.toggleModal} className="nav-link" to="/feedback">
                                Feedback
                                    </NavLink>
                        </NavItem>
                    </Nav>
